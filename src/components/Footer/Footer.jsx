      ...
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-brand">
            <a className="footer-logo" href="#top">Dr. Seyit Han Hırlı</a>
            <p>
              Bu site bilgilendirme amaçlıdır, sağlık hizmeti vermez. Tanı ve
              tedavi için mutlaka doktorunuza danışınız.
            </p>

            <div className="footer-socials">
              <a href="tel:+902125550000" aria-label="Telefon ile iletişime geçin">
              ...
              <a href="mailto:iletisim@seyithanhirli.com" aria-label="E-posta gönderin">
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} Dr. Seyit Han Hırlı — Tüm Hakları Saklıdır.</p>
